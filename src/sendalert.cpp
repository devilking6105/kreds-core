...
1. Modify alert parameters below, see alert.* and comments in the code
   for what does what.
2. run hthd with -printalert or -sendalert like this:
   /path/to/hthd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://hthcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/HTH Core:0.12.0.58/"));
