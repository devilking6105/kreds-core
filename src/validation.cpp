...
const std::string strMessageMagic = "Kreds Signed Message:\n";
...
{
    return GetBlockSubsidy(0, nHeight, consensusParams);
}
...
{   
    ...
    // Give masternode 50% of block value
    CAmount ret = blockValue / 100 * 50;
